...
function AdvtCard(props) {
  const { advt, className } = props;
        ...
        <Container>
          ...
          <Content>
            <div className={css.price}>
              <span>{formatNumber(advt.price)} р.</span>{" "}
              <span>{formatNumber(advt.price_usd)} $</span>
            </div>
            <div className={css.mileage}>
              Пробег: <span>{formatNumber(advt.mileage)} км. </span>
            </div>
