...
import css from "./filteradvertsbar.module.css";
import { addOrRemoveItemInArray, formatNumber } from "../../helpers";

const FilterAdvertsBar = (props) => {
        ...
        <div className={css.block_choice}>
          <FlexboxGrid align="middle">
            <FlexboxGrid.Item colspan={14}>
              <p className={css.label}>Цена, {state.currency.unit}</p>
            </FlexboxGrid.Item>
            <FlexboxGrid.Item colspan={10}>
              <div className={css.currency}>
                <div
                  ...
                  className={
                    state.currency.label === "BYN" ? css.active_currency : ""
                  }
                >
                  BYN
                </div>
                <div
                  ...
                  className={
                    state.currency.label === "USD" ? css.active_currency : ""
                  }
                >
                  USD
                </div>
