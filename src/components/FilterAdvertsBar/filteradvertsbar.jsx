...
const FilterAdvertsBar = () => {
  ...
  const { isLogined, userId } = useSelector((state) => state.user);
  const {
    countAllAdverts,
    isFilterChanged,
    isNeedFetchAdverts,
  ...
  const [showFilterSaveModal, setShowFilterSaveModal] = React.useState(false);
  ...
  const openFilterSaveModal = () => setShowFilterSaveModal(true);
  ...
  return (
    <div>
      <Panel className="filter-adverts-bar-component" bodyFill>
        <Panel>
            ...
            <div>
              <InputGroup className="user-choice">
                <InputNumber
                  ...
                  min={0}
                  onChange={(priceMin) =>
                    setInputNumberValue("priceMin", priceMin)
                  }
                />
                <InputNumber
                  size="md"
                  ...
                  min={0}
                  onChange={(priceMax) =>
                    setInputNumberValue("priceMax", priceMax)
                  }
                />
              </InputGroup>
            </div>
            ...
            {state.models.map((model, index) => (
              <div key={model.id}>
                ...
                <div className="user-choice">
                  <FlexboxGrid align="middle">
                    <FlexboxGrid.Item
                      colspan={state.models.length > 1 ? 21 : 24}
                    >
                      <ModelPicker
            ...
            <div>
              <InputGroup className="user-choice">
                <InputNumber
                  ...
                  min={1930}
                  onChange={(yearMin) =>
                    setInputNumberValue("yearMin", yearMin)
                  }
                />
                <InputNumber
                  size="md"
                  ...
                  min={1930}
                  onChange={(yearMax) =>
                    setInputNumberValue("yearMax", yearMax)
                  }
                />
              </InputGroup>
            </div>
        ...
        {isFilterChanged && (
          <ButtonGroup justified className="reset-save-wrapper">
            <Button onClick={onResetFilter}>
              <Icon icon="close" /> сбросить
            </Button>
            {isLogined && (
      ...
      <FilterSaveModal
        show={showFilterSaveModal}
        onClose={closeFilterSaveModal}
        onSave={onSaveFilter}
      />
    </div>
  );
